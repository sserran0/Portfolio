...
export default function Page() {
  return (
    <>
      <Header />
      <h2 className="text-xl font-semibold font-heading mb-2 mt-10 ml-10">
        About
      </h2>
      <main className="w-full max-w-[900px] mx-auto bg-[#111319]/90 border border-[#242736] rounded-2xl shadow-md p-6">
      ...
      <section
        id="contact"
        className="w-full max-w-[900px] mx-auto bg-[#111319]/90 border border-[#242736] rounded-2xl shadow-md p-6"
      >
        <p>
          <a
